...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We received a request to reset your password for your Hostoo account.</p>
            
            <!-- Standard Laravel Reset Link Structure -->
            <a href="{{ route('password.reset', $this->token) }}?email={{ $user->email }}" class="btn">Reset Password</a>
        ...
        <div class="footer">
            ...
            <a href="{{ route('privacy') }}" style="color: #999; text-decoration: none;">Privacy Policy</a>
        </div>
    </div>
</body>
</html>
